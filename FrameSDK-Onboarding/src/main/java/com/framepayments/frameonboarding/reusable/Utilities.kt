 ...
 *
 * @param brand Card brand string (e.g. `"visa"`, `"mastercard"`, `"amex"`), or `"BANK"` for an
 *   ACH payout method. Case-insensitive.
...
fun cardBrandIcon(brand: String): Int {
    ...
    if (normalized == "bank" || normalized == "ach") return com.framepayments.framesdk_ui.R.drawable.ic_bank
